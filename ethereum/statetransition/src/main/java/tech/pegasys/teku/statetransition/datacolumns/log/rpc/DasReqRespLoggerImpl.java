          ...
          new ReqRespMethodLogger<>() {
            ...
            public ResponseLogger<DataColumnSidecar> onInboundRequest(
              ...
              return new DasByRootResponseLogger(
                  timeProvider, AbstractResponseLogger.Direction.INBOUND, fromPeer, request,logger,logLevel);
            }
            ...
            public ResponseLogger<DataColumnSidecar> onOutboundRequest(
              ...
              return new DasByRootResponseLogger(
                  timeProvider, AbstractResponseLogger.Direction.OUTBOUND, toPeer, request,logger,logLevel);
            }
          };
