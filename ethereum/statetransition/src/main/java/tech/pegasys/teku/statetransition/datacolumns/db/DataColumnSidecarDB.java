...
public interface DataColumnSidecarDB {
  ...
  default DataColumnSidecarDB withAutoPruning(MinCustodySlotSupplier minCustodySlotSupplier) {
    return new PruningDasDb(this, minCustodySlotSupplier);
  }

  default ColumnIdCachingDasDb withColumnIdCaching(int numberOfColumns) {
    return new ColumnIdCachingDasDbImpl(this, numberOfColumns);
  }
}
